function generate_advection_implicite_retarde_t_centre_x_periodique()
clear
format long
...
%
entry = 1;
fileID = fopen("sol-advection_impl_ret_t_cent_x.txt","w");
for v=1:4
     for lb=[1 2 3]
        for N=100:20:200
            for l=1:4
