...
gpar=sprintf('%d ', PARAM);
fprintf(fileID,"footable[%i]:[%s,significantfigures(%f,6),significantfigures(%f,6),significantfigures(%f,6),significantfigures(%f,6)];\n",id,gpar,ysol(end,2),yEuler(end,2),yRK2(end,2),yRK4(end,2));
